...
<head>
    <meta charset="UTF-8">
    <title>| Responsive Homework | modificar</title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#">Modificar Noticia <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
                <?php
                    ...
                    /* Prepara consulta */ 
                    $sql = "SELECT * FROM `noticias` WHERE `id` = '$nId';";
                    /* Ejecuta la consulta */
                    $result = $conn->query($sql);
                    if($result &&  $result->num_rows != 0){
                        $noticiaOb = $result->fetch_assoc();
                        echo'
                                <h1>Rellene los campos</h1>
                                <h6>Todos son obligatorios</h6>
                                <div class="form-group">
                                    <form action="mod.php?id='.$nId.'" method="POST" enctype="multipart/form-data">
                                        Titulo: <br>
                                        <input class="form-control" type="text" name="titulo" value="'.$noticiaOb['titulo'].'">
                                        Imagen:<br>
                                        <input class="form-control-file" type="file" accept="image/jpeg" name="imagen">
                                        (seleccionar de nuevo) Categoría:<br>
                                        ...
                                        Texto:<br>
                                        <textarea class="form-control rounded-0" name="texto">'.$noticiaOb['texto'].'</textarea>
                                        <br>
                                        <input class="btn btn-primary" type="submit" value="Modificar Noticia">
                                    </form>
                                </div>
                            ';
                        }else{
